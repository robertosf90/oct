...
public class BeneficioFiscalPurchaseServiceImplPortBindingStub extends org.apache.axis.client.Stub implements oi.brm.wsm.service.BeneficioFiscalPurchaseServiceImpl {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "beneficioFiscalPurchaseInput"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://service.wsm.brm.ig/", "BeneficioFiscalPurchaseFlistIn"), oi.brm.wsm.service.BeneficioFiscalPurchaseFlistIn.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://service.wsm.brm.ig/", "BeneficioFiscaloPurchaseFlistOut"));
    ...
    public BeneficioFiscalPurchaseServiceImplPortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BeneficioFiscalPurchaseServiceImplPortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public oi.brm.wsm.service.BeneficioFiscaloPurchaseFlistOut IG_OP_SCM_BENEFICIO_FISCAL_PURCHASE(oi.brm.wsm.service.BeneficioFiscalPurchaseFlistIn beneficioFiscalPurchaseInput) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://service.wsm.brm.ig/", "IG_OP_SCM_BENEFICIO_FISCAL_PURCHASE"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {beneficioFiscalPurchaseInput});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                ...
                return (oi.brm.wsm.service.BeneficioFiscaloPurchaseFlistOut) org.apache.axis.utils.JavaUtils.convert(_resp, oi.brm.wsm.service.BeneficioFiscaloPurchaseFlistOut.class);
            }
        }
